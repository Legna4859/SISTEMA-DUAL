                            ...
                            <ul class="nav nav-pills nav-stacked" style="background-color:white;border: 2px solid black; border-radius: 7px; padding-right: 0px">
                                @foreach($carreras as $carrera)
                                    <li style="margin-top: 0px" class="text-center">
                                        <a style="border-bottom: 2px solid black;" data-toggle="pill" href="#" onclick="window.location='{{ url('/duales/concentrado_calificaciones_duales/semestres/'.$carrera->id_carrera ) }}'" >   
                                        {{$carrera->nombre}}
                                    </a>
                                    </li>
