...
class PDF extends FPDF
{
    ...
    function Header()
    {
        $this->Image('img/tes.PNG', 110 , 15, 40);
    ...
    function Footer()
    {
        ...
        //$this->Image('img/pie/logos_iso.jpg',30,185,50);
        // $this->Image('img/sga.PNG',65,183,20);
        $this->Cell(100);
        $this->Cell(150,-2,utf8_decode('FO-TESVB-39  V.1  14-08-2019'),0,0,'R');
        $this->Ln(3);
        $this->Cell(100);
...
class Dual_PDF_Carga_Academica_Control extends Controller
{
    public function index($id){
        ...
        $pdf->Cell(80);
        $pdf->Cell(100,10,utf8_decode('TECNOLÓGICO DE ESTUDIOS SUPERIORES DE VALLE DE BRAVO'),0,1,'C');
        $pdf->Ln(1);
        ...
        $id_usuario=($validaciones[0]->id_alumno);
        //dd($validaciones);
