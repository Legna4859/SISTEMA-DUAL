...
use App\Exports\Dual_Concentrado_Calificaciones_Alumnos;
use Session;

class Dual_Excel_Concentrado extends Controller
{
    ...
    //dd($materias_calificaciones);
        ...
        // Instanciar la clase de exportación y pasar las variables
        $export = new Dual_Concentrado_Calificaciones_Alumnos(
            $alumnos,
        ...
        return Excel::download($export, 'concentrado_calificaciones.xlsx');
    }
