...
//dd($usuario);
            return view('duales.checar_carga_academica',compact('validaciones','usuario','re',
                'suma','cuenta_y_nom','creditoss','id_alu','datos_carga'));
...
//dd($usuario);
...

    {
        ...
        for ($i=0; $i <$ciclos ; $i++)
        {
            ...
            $verifica=DB::selectOne('SELECT * FROM eva_carga_academica WHERE id_materia='.$checks[$i].' 
            AND id_periodo ='.$periodo.' AND eva_carga_academica.id_alumno='.$id_alu.'');
    ...
    public function edit($id_carga_academica)
    {
        ...
        else
        {
            ...
            */
            ...
            return view('duales.checar_carga_academica',
                compact('datos_carga','usuario','re','validaciones','semestre','suma','id_alumno'))->with(['edit'=>true,'consultaedit'=>$sss]);
